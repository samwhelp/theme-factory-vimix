...
base_var_init () {
	...
	THE_SOURCE_ROOT_THEME_DIR_NAME="vimix-icon-theme"
	THE_SOURCE_ROOT_THEME_DIR_PATH="${THE_MASTER_ASSET_DIR_PATH}/${THE_SOURCE_ROOT_THEME_DIR_NAME}"
	...
	THE_TARGET_ROOT_THEME_DIR_NAME="dist"
	THE_TARGET_ROOT_THEME_DIR_PATH="${THE_MASTER_TMP_DIR_PATH}/${THE_TARGET_ROOT_THEME_DIR_NAME}"
...
base_var_dump () {
	...
	util_debug_echo "THE_SOURCE_ROOT_THEME_DIR_NAME=${THE_SOURCE_ROOT_THEME_DIR_NAME}"
	util_debug_echo "THE_SOURCE_ROOT_THEME_DIR_PATH=${THE_SOURCE_ROOT_THEME_DIR_PATH}"
	util_debug_echo
	...
	util_debug_echo "THE_TARGET_ROOT_THEME_DIR_NAME=${THE_TARGET_ROOT_THEME_DIR_NAME}"
	util_debug_echo "THE_TARGET_ROOT_THEME_DIR_PATH=${THE_TARGET_ROOT_THEME_DIR_PATH}"
	util_debug_echo
